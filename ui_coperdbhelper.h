...
public:
    ...
    void setupUi(QWidget *COperDbHelper)
    {
        ...
        m_sqlEdit->setGeometry(QRect(60, 240, 801, 91));
        ...
        m_btnProSql->setGeometry(QRect(620, 333, 81, 23));
